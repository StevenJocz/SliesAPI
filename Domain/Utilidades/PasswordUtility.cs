...
namespace SLIES.Domain.Utilidades
{
    public interface IPasswordUtility
    {
        ...
        Task<bool> VerifyPassword(string enteredPassword, string savedHashedPassword);
    ...
    public class PasswordUtility : IPasswordUtility
    {
        ...
        public async Task<bool> VerifyPassword(string enteredPassword, string savedHashedPassword)
        {
